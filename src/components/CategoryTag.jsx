    ...
    export const CategoryTag = ({lable, removeCategory, isSelected=true}) => {

    return (
        <div className={`inline-flex flex-row items-center justify-between h-6 gap-2 px-3 py-4 rounded-lg  ${ isSelected === true ? 'bg-black/50 group' : ''}`}>
